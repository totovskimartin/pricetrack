        ...
        <CardContent className="space-y-4">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="emailOrUsername">Имейл или потребителско име</Label>
              <Input
                id="emailOrUsername"
                type="text"
          ...
          <div className="text-center text-sm">
            ...
            <Link href="/bg/register" className="text-blue-600 hover:underline">
              Регистрирайте се
            </Link>
          </div>

          <div className="text-center">
            <Link href="/bg/forgot-password" className="text-sm text-blue-600 hover:underline">
              Забравена парола?
            </Link>
          </div>
        </CardContent>
